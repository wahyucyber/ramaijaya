				...
				<div class="card-body">
					...
					<div class="form-group mb-4">
						<div class="row">
							...
							<div class="col-md-9">
								<textarea rows="5" class="form-control deskripsi ckeditor input--length" id="ckeditor" maxlength="2000" placeholder="Berikan informasi dengan jelas dan serinci mungkin produk yang"></textarea>
							</div>
						</div>
					</div>
					<!-- <div class="form-group mb-4">
						...
						<div class="row">
							...
							<div class="col-md-9">
								<div class="custom-control custom-switch">
								  <input type="checkbox" class="custom-control-input" disabled id="status-produk" checked>
